...
#ifndef PHP_PCSPEAK_H
#define PHP_PCSPEAK_H
...
#	define PHP_PCSPEAK_API __attribute__ ((visibility("default")))
#else
#	define PHP_PCSPEAK_API
#endif
...
#ifdef ZTS
#define PCSPEAK_G(v) TSRMG(pcspeak_globals_id, zend_pcspeak_globals *, v)
#else
#define PCSPEAK_G(v) (pcspeak_globals.v)
#endif
